...
public class Application extends MultiThreadedApplicationAdapter {
	...
	public boolean appStart(IScope arg0) {
		...
		try {
			...
			hlsSegmentFolder = new File(this.getHomeDirectory() + File.separator + "webapps" + File.separator + getScope().getName() +  File.separator + "streams" + File.separator + "hls");
			if(!hlsSegmentFolder.exists()) hlsSegmentFolder.mkdirs();
	...
	public void streamBroadcastStart(IBroadcastStream stream) {
		...
		request.setWorkingDirectory(hlsSegmentFolder.getAbsolutePath());
